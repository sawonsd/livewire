...
<a wire:navigate class="sidebar-link gap-3 py-2.5 my-1 text-base  flex items-center relative  rounded-md text-gray-500  w-full" href="/"
>
...
<li class="sidebar-item">
<a class="sidebar-link gap-3 py-2.5 my-1 text-base   flex items-center relative  rounded-md text-gray-500  w-full" wire:navigate href="student"
>
<i class="ti ti-article ps-2 text-2xl"></i> <span>Student</span>
</a>
</li>
